...
<head>
    ...
    <link rel="stylesheet" href="http://localhost:9000/myshop/resources/css/admin_order_management.css">
    ...
    <script src="http://localhost:9000/myshop/resources/js/allcheck.js"></script>
            ...
            <div class="recent-grid">
                <div class="customercares">
                    ...
                    <nav class="tabmenu">
                            ...
                            <label for="tab1">신규주문</label>
                            <span>|</span>
                            <input type="radio" name="tab" id="tab2" checked>
                            <label for="tab2">입금대기</label>
                            <span>|</span>
                            <input type="radio" name="tab" id="tab3" checked>
                            <label for="tab3">결제완료</label>
                            <span>|</span>
                            <input type="radio" name="tab" id="tab4" checked>
                            <label for="tab4">배송준비중</label>
                            <span>|</span>
                            <input type="radio" name="tab" id="tab5" checked>
                            <label for="tab5">배송중</label>
                            <span>|</span>
                            <input type="radio" name="tab" id="tab6" checked>
                            <label for="tab6">배송완료</label>
                            
                            <div class="card-body" id="cont1">
                                <nav class="tab_type1">
                                    <ul>
                                    <li><a href="#a">발송처리</a></li>
                                    <li><a href="#a" class="on">배송준비 처리</a></li>
                                    <li><a href="#a">입금확인 처리</a></li>
                                    <li><a href="#a">기타주문 처리</a></li>
                                    <li><a href="#a">판매취소</a></li>
                                    <li><a href="#a">반품처리</a></li>
                                    <li><a href="#a">교환처리</a></li>
