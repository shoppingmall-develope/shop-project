    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href=""><span class="las la-user-circle"></span><span>게시판 관리</span></a>
                </li>
                <li>
    ...
    <div class="main-content">
        <header>
            ...
            <div class="user-wrapper">
                <img src="resources/images/4dda8b6ed915b478044d8db587d11da7.jpeg" alt="" width="30px" height="30px" display="inline">
                <div>
                    <h4>고범규</h4>
