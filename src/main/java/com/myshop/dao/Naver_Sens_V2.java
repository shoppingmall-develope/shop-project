...
public class Naver_Sens_V2 {
	...
	public void send_msg(String pnumber, String rand) {
        ...
        String accessKey = "nQ2TEzMRZMyxbICFYgTg";                     						// 개인 인증키
        String secretKey = "3DKnGsDmGGkNdNBLpd2yjmqEFoaYv6lk23Z9FfSb";  										// 2차 인증을 위해 서비스마다 할당되는 service secret
        String serviceId = "ncp:sms:kr:293451852456:shop";        									// 프로젝트에 할당된 SMS 서비스 ID
