...
<link rel="stylesheet"
	href="http://localhost:9000/myshop/resources/css/admin_product_write.css">
<link rel="stylesheet"
	href="//cdn.jsdelivr.net/npm/xeicon@2.3.3/xeicon.min.css">
<link rel="stylesheet"
	href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@48,400,0,0" />
<script
	src="http://localhost:9000/myshop/resources/js/jquery-3.6.0.min.js"></script>
<script src="http://localhost:9000/myshop/resources/js/my_category.js"></script>
<script src="http://localhost:9000/myshop/resources/js/admin_product_write.js"></script>
...
<body>
	...
	<main>
		...
		<div class="recent-grid">
			...
			<form name="addProductForm" action="admin_product_write_check.do"
				...
				<div class="product_content">
					...
					<input type="hidden" class="rating" name="rating"id="rating">
						<table class="product_list_content">
							<tr>
								...
								<td colspan="3">
									<div class="cate_wrap_list">
										<div class="cate_wrap">
											<span class="category_name">대분류</span> <select class="cate1" >
										...
										<div class="cate_wrap">
											<span class="category_name">중분류</span> <select class="cate2">
											</select>
										</div>
										<div class="cate_wrap">
											<span class="category_name">소분류</span> <select class="cate3"
												name="category_id">
											</select>
										</div>
									</div>
							...
							<tr>
								<th>상품명<span>*</span></th>
								<td><input type="text" class="pname" name="pname"
									id="pname"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" class="quantity" name="quantity"
									placeholder="숫자만 입력"></td>
							</tr>
							<tr>
								<th>사이즈<span>*</span></th>
								<td><input type="text" class="psize" name="psize"></td>
							</tr>
							<tr>
							...
							<tr>
								<th>배송비<span>*</span></th>
								<td><input type="text" class="delivery_price"
									name="delivery_price"></td>
							</tr>
							...
							<tr>
								...
								<td><input type="file" multiple="multiple" name="file1" class="file1"
									style="display: block;"></td>
							</tr>
						</table>
						<div class="addProductbtns">
							<button class="product_btn" id="product_btn" type="button">등록</button>
